...
CREATE TABLE IF NOT EXISTS `FeedbackComment` (
  ...
  `suggestionId` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_feedback_comment_suggestion` (`suggestionId`),
  KEY `idx_feedback_comment_parent` (`parentId`)
