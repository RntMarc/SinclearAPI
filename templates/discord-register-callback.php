...
<head>
    ...
    <title>Discord-Registrierung – Sinclear Beyond</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        h1 { font-size: 1.25rem; margin-bottom: 0.5rem; color: #57F287; }
...
<body>
    <div class="card">
        ...
        <p>Gib diesen Code in der App ein, um dein neues Konto zu aktivieren.</p>
