...
| `POST` | `/api/v2/auth/login/discord/start` | – | Discord OAuth-URL generieren |
| `GET` | `/api/v2/auth/login/discord/callback` | – | Discord-Redirect verarbeiten |
...
| **Guild-Prüfung** | Nur Mitglieder der konfigurierten Discord-Guild können sich anmelden |
