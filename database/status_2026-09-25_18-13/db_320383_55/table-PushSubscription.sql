...
CREATE TABLE IF NOT EXISTS `PushSubscription` (
  ...
  `type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'webpush or unifiedpush',
  ...
  `lastError` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `fk_pushsub_user` FOREIGN KEY (`userId`) REFERENCES `User` (`id`) ON DELETE CASCADE
