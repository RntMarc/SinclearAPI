...
final readonly class ChatEventPublisher
{
     ...
     *
     * @param array{id: string, seq: int, conversationId: string, senderId: string, sender: array, type: string, content: string, payload: mixed, clientId: string|null, editedAt: string|null, deleted: bool, createdAt: string} $formattedMessage
     */
