...
CREATE TABLE IF NOT EXISTS `LocationSharingSession` (
  ...
  `sharingMode` enum('location','route') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'location',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_ls_session_token` (`token`),
