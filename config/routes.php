...
return function (App $app): void {
    ...
    $app->group('/explore', function (RouteCollectorProxy $group) use ($container) {
        ...
        $group->get('/submissions/{id}', [PlaceSubmissionController::class, 'get']);
        $group->put('/submissions/{id}', [PlaceSubmissionController::class, 'update']);
    ...
    $app->group('/user', function (RouteCollectorProxy $group) {
        ...
        $group->get('/me/weather-locations', [UserWeatherLocationController::class, 'list']);
        $group->post('/me/weather-locations', [UserWeatherLocationController::class, 'create']);
        $group->put('/me/weather-locations', [UserWeatherLocationController::class, 'replaceAll']);
        $group->patch('/me/weather-locations/{id}', [UserWeatherLocationController::class, 'update']);
        $group->delete('/me/weather-locations/{id}', [UserWeatherLocationController::class, 'delete']);
    ...
    $app->group('/public/recipes', function (RouteCollectorProxy $group) {
