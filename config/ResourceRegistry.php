...
return [
    ...
    ['route' => 'direct-chats', 'table' => 'direct_chats', 'policy' => DirectChatPolicy::class],
    ['route' => 'chat-read-receipts', 'table' => 'chat_read_receipts', 'policy' => SnakeOwnerPolicy::class],
    ['route' => 'user-presence', 'table' => 'user_presence', 'policy' => SnakeOwnerPolicy::class, 'pk' => 'user_id'],
    ['route' => 'user-devices', 'table' => 'user_devices', 'policy' => SnakeOwnerPolicy::class],
    ['route' => 'sse-events', 'table' => 'sse_events', 'policy' => SnakeOwnerPolicy::class],
